...
export default function AuctionMachine({
  collections,
      ...
      <div className="auction-machine-inner-wrapper">
        ...
        <div className="selector">
          ...
          <div className="selector-inner-wrapper">
            <Button
              childern={<img src="/whitearrowleft.svg" alt="" />}
              styles={SelectorButtonStyles}
            />
            <div className="btn-text">Hottest Auctions</div>
            <Button
              childern={<img src="/rightarrowwhite.svg" alt="" />}
              styles={SelectorButtonStyles}
            />
          </div>
          <TwistedBorder />
        ...
        <div className="buy-section">
          ...
          <div className="inner-wrapper">
            ...
            <div className="right-section">
              <div className="price">
                <span>
                  Starting price <img src="/blackwarnlogo.svg" alt="" />
                </span>
                <span>$8.0</span>
              </div>
              <div className="bid">
                <span>
                  Highest bid <img src="/blackbid.svg" alt="" />
                </span>
                <span>$8.0</span>
              </div>
              <TwistedBorder />
