...
export default function App() {
  ...
  return (  
    <Router>
      ...
      <Route path="/auction_house/create_single_auction" element={<CreateSingleAuction/>}/>     
      <Route path="/auction_house/create_collection_auction" element={<CreateCollectionAuction/>}/>     
    </Routes>
    </Router> 
  )
}
